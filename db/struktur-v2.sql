...
CREATE TABLE IF NOT EXISTS `armada` (
  `id_armada` int(4) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `galery` (
  `id_galery` int(4) NOT NULL AUTO_INCREMENT,
...
--
-- Table structure for table `kota_wisata`
--

CREATE TABLE IF NOT EXISTS `kota_wisata` (
  `id_kotawisata` int(4) NOT NULL AUTO_INCREMENT,
  `kotawisata` varchar(200) NOT NULL,
  `gambar` text NOT NULL,
  `link` varchar(50) NOT NULL,
  PRIMARY KEY (`id_kotawisata`)
